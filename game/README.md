...
A small first-person shooter built for the **Godot Engine** (not a browser/HTML game — it runs as a real desktop application). Starts at a real main menu with settings, then drops you onto a circular island ringed by ocean — grass fields with real grass blades poking out of the ground, sandy beaches, patches of pine and broadleaf forest, scattered rocks, snow-capped mountains on the distant horizon, and a small village of red-roofed houses — with a central combat clearing holding a watchtower, barrels, pillars, cover walls and crates, real recorded sound effects and music, real-time lighting and shadows, physics-based movement, three switchable weapons (including a dashing one-hit-kill knife), blood-spray and hit-marker feedback, a fleshed-out HUD, and human soldier enemies — each with their own uniform and gear color scheme — that walk, flinch, collapse when killed, and shoot back with imperfect (not aimbot) accuracy.
